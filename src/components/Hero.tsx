      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Join thousands of event enthusiasts. Create, discover, and attend incredible events 
            that bring communities together. Your next unforgettable experience is just a click away.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Easy Event Creation</h3>
                <p className="text-purple-100 text-sm">Create and manage events with our intuitive interface</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg">
                <Users className="h-8 w-8 text-blue-300 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Connect with People</h3>
                <p className="text-purple-100 text-sm">Meet like-minded individuals at amazing events</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 ring-1 ring-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg">
                <MapPin className="h-8 w-8 text-pink-300 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Discover Local Events</h3>
                <p className="text-purple-100 text-sm">Find exciting events happening in your area</p>
              </div>
            </div>
          </div>
        </div>
