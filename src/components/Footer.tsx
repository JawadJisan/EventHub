        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Your ultimate destination for discovering, creating, and managing amazing events. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/add-event" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Create Event
                </Link>
              </li>
              <li>
                <Link to="/my-events" className="text-gray-300 hover:text-purple-400 transition-colors">
                  My Events
                </Link>
              </li>
            </ul>
